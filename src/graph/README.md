...
The Rampart Controller serves as the controller of the [Kubernetes Operator](https://kubernetes.io/docs/concepts/extend-kubernetes/operator/) for the RampartGraph custom resource. It contains three seperate components with the following roles:
